    ...
    public void creation() {
        ...
        switch (randomAnimal % 4) {
            case 0:
                ...
                bear.setCost(BigDecimal.valueOf(Math.random() * 1_000_000).setScale(2, RoundingMode.HALF_UP));
            ...
            case 1:
                ...
                wolf.setCost(BigDecimal.valueOf(Math.random() * 10_000).setScale(2, RoundingMode.HALF_UP));
            ...
            case 2:
                ...
                cat.setCost(BigDecimal.valueOf(Math.random() * 100_000).setScale(2, RoundingMode.HALF_UP));
            ...
            case 3:
                ...
                parrot.setCost(BigDecimal.valueOf(Math.random() * 10_000).setScale(2, RoundingMode.HALF_UP));
